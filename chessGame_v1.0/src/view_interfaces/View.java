...
//	public boolean splitPieces();
	...
	/**
    * Resets the game board and gets player preferences for a new game.
    * Default preferences for a new game are the preferences from the previous
    *  game. Guarantees that player names are unique and that preferred game length 
    * is a valid integer.
    * 
    */
	public void newGame();
