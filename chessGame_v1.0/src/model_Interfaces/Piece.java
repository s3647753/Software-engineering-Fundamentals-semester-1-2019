...
/**
 * Interface for the Chess Pieces. Note: Pieces are immutable.
 * 
...
public interface Piece extends Comparable<Piece> {
   ...
   /**
    * Builds a code for the piece suitable for text display or building filenames
    * for piece images. <color, type> e.g. blackRook = "BR", whiteKnight = "WK"
    * 
